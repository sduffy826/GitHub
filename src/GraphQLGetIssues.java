...
public class GraphQLGetIssues {
  ...
  public static void main(String[] args) {    
    GraphQLGetIssues graphQLGetIssues = new GraphQLGetIssues();
    graphQLGetIssues.callingIBMGraph(graphQLGetIssues.issues2Get, graphQLGetIssues.call2Make);    
  }
  ...
  public void callingIBMGraph(int _numberToPull, String _call2Make) {
    ...
    String gitHubGraphQLQuery = GetRequestFromInputFile.getRef().getString4Key(_call2Make);
    ...
    if (DEBUGIT) logger.info("jsonValue:" + gitHubGraphQLQuery + "\njsonString:" + jsonString);
    ...
    try {
      StringEntity entity = new StringEntity(jsonString); //gitHubGraphQLQuery); // jsonString);
      ...
      SearchQuery sq2 = jsonUtils.getPojoFromJsonNode(searchNode, SearchQuery.class);
      System.out.println(sq2);
      
      // SearchQuery sq1 = objectMapper.readValue(searchNode, SearchQuery.class);
